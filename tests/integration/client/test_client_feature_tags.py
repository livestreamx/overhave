...
class TestFeatureTagsApiClient:
    ...
    def test_get_feature_tags_item(
        ...
        item = api_client.get_feature_tags_item(value=test_tag.value)
    ...
    def test_get_feature_tags_with_unknown_value(
        ...
        with pytest.raises(HTTPStatusError):
            api_client.get_feature_tags_item(value=faker.word())
    ...
    def test_get_feature_tags_list(
        ...
        items = api_client.get_feature_tags_list(value=test_tag.value)
        assert len(items) >= 1
    ...
    def test_get_feature_tags_list_with_unknown_value(
        ...
        items = api_client.get_feature_tags_list(value=faker.word())
        assert len(items) == 0
